...
Imagelist = list(os.listdir(current_working_directory+ '/Stimuli_faces'))
print(Imagelist)
print(len(Imagelist))


Image = visual.ImageStim(win=win, name='Image', image='/Users/ziweizhang/Documents/CL/Stimuli_faces/CK_f_01.jpg', size=(0.42, 0.5), interpolate = True)
Blank = visual.TextStim(win=win, name='blank', text='+', font=u'Arial', pos=(0, 0), height=0.1, wrapWidth=None, ori=0, color=u'black', colorSpace='rgb', opacity=1, depth=0.0);
...
for trial in range(len(stim_image)):
    ...
    #    while trialClock.getTime() < ITI + duration:
