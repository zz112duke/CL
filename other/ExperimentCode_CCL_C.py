...
Image = visual.ImageStim(win=win, name='Image', 
    image='\\Users\\zz112\\Documents\\CCL\\Stimuli_faces\\CK_f_01.jpg', mask=None,
...
stim_image_high = [Imagelist[i] for i in indices_high]*10
stim_image_medium = [Imagelist[i] for i in indices_medium]*5
stim_image_low = [Imagelist[i] for i in indices_low]
...
expmatrix = [stim_image, frequency, congruency, corrAns, duration, ITI]
expmatrix = pd.DataFrame(expmatrix)
expmatrix = expmatrix.transpose()
print(expmatrix)
expmatrix = expmatrix.sample(frac=1).reset_index(drop=True)
print(expmatrix)
